...
> **Project Scope**: *An enterprise payment recovery intelligence engine built for Razorpay APIs.*
...
## 🖼️ Visual Interface & Live Telemetry

### 1. Real-Time Operational Dashboard (`http://localhost:5173`)
![ARIA Dashboard Hero Banner](aria-dashboard/src/assets/hero.png)

### 2. Live Prometheus Telemetry Endpoint (`http://127.0.0.1:8000/metrics/prometheus`)
![ARIA Prometheus Telemetry Endpoint](aria-dashboard/src/assets/prometheus_metrics.png)

---

## 🚀 One-Click Live Cloud Deployment

### 1. Deploy Frontend Dashboard to Vercel (Free)
1. Fork or clone this repository on GitHub.
2. Go to **[vercel.com/new](https://vercel.com/new)** and import your `ARIA` repository.
3. Set **Root Directory**: `aria-dashboard`
4. Set **Build Command**: `npm run build` and **Output Directory**: `dist`
5. Click **Deploy**. Your dashboard will be live at `https://aria-dashboard.vercel.app`!

### 2. Deploy FastAPI Backend to Render (Free)
1. Go to **[render.com](https://render.com)** and create a new **Web Service**.
2. Connect your GitHub repository `ARIA`.
3. Set **Runtime**: `Python 3`
4. Set **Build Command**: `pip install -r requirements.txt`
5. Set **Start Command**: `uvicorn main:app --host 0.0.0.0 --port $PORT`
6. Click **Create Web Service**. Your backend API will be live at `https://aria-backend.onrender.com`!
